                        ...
                        >
                            {
                                userInfo && userInfo.role === 1 ?
                                    <>
                                        ...
                                        <MenuItem component={<Link to="/admin/users" />} icon={<GroupAddIcon />}> Liste des Employés </MenuItem>
                                        <MenuItem component={<Link to="/admin/jobs" />} icon={<WorkIcon />}> Jobs </MenuItem>
                                        <MenuItem component={<Link to="/admin/category" />} icon={<CategoryIcon />}> Catégories </MenuItem>
                                    </> :
                                    <>
                                        ...
                                        <MenuItem component={<Link to="/user/info" />} icon={<Person3Icon />}> Informations Personnelles </MenuItem>
                                    </>
                            }
